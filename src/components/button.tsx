...
const variantClassMap: Record<Variant, string> = {
    ...
    rainbow: "border border-black/8 bg-[linear-gradient(120deg,#fffef9,#fef6dd,#fff5f3,#ffe4e1)] text-[var(--text-primary)] shadow-[0_8px_0_rgba(252,234,187,0.3),0_0_0_1px_rgba(0,0,0,0.05),0_2px_8px_rgba(0,0,0,0.1)] hover:-translate-y-[2px] hover:shadow-[0_10px_0_rgba(252,234,187,0.35),0_0_0_1px_rgba(0,0,0,0.05),0_4px_12px_rgba(0,0,0,0.12)] active:translate-y-[1px] active:shadow-[0_4px_0_rgba(252,234,187,0.25),0_0_0_1px_rgba(0,0,0,0.05),0_1px_4px_rgba(0,0,0,0.08)] focus-visible:ring-[var(--accent-amber)]",
